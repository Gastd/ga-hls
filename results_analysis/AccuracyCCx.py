...
exp = 2
if exp == 1:
    totalRange = np.array([0.0, 0.0, 50.0, 50.0, 5.0, 10.0])
    toolSatis = np.array([[0.0, 0.0, 50.0, 50.0, 5.0, 7.366460]])
    expertSatis = np.array([[0.0, 0.0, 50.0, 50.0, 5.0, 7.389400]])
    
elif exp == 2:
    totalRange = np.array([0.0, 25.0, 25.0, 75.0, 5.0, 10.0])
    toolSatis = np.array([[0.0, 25.0, 25.0, 75.0, 5.0, 7.387821],
                          [18.480240, 25.0, 25.0, 75.0, 7.387821, 8.909810],
                          [19.712574, 25.0, 25.0, 34.698821, 8.909810, 9.358075]])
    expertSatis = np.array([[0.0, 18.2, 25.0, 75.0, 5.0, 7.4],             
                            [18.2, 25.0, 25.0, 75.0, 5.0, 8.9],
                            [18.2, 25.0, 25.0, 39.6, 8.9, 9.3]])
...
# Print results
if exp == 1:
    print("The results of the effectiveness analysis on CCx - experiment 31 are as follows:")
else:
    print("The results of the effectiveness analysis on CCx - experiment 32 are as follows:")
