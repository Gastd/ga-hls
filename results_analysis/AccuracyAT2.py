...
exp = 2
if exp == 1:
    totalRange = np.array([0.0, 0.0, 10.0, 10.0, 4700.0, 4800.0])
    toolSatis = np.array([[0.0, 0.0, 10.0, 10.0, 4754.377727, 4800.0]])
    expertSatis = np.array([[0.0, 0.0, 10.0, 10.0, 4754.4012, 4800.0]])
    
elif exp == 2:
    totalRange = np.array([0.0, 5.0, 5.0, 15.0, 4700.0, 4800.0])
    toolSatis = np.array([[0.0, 5.0, 5.000000, 7.171464, 4700.000000, 4754.193158],
                          [0.0, 5.0, 7.171464, 7.300182, 4722.220239, 4754.193158],
                          [0.0, 5.0, 5.000000, 15.000000, 4754.193158, 4800.000000]])
    expertSatis = np.array([[0.0, 5.0, 5.0, 7.1, 4700.0, 4800.0],             
                          [0.0, 5.0, 7.1, 15.0, 4754.4, 4800.0]])
    
elif exp == 3:
    totalRange = np.array([0.0, 5.0, 5.0, 15.0, 4700.0, 4800.0])
    toolSatis = np.array([[0.0, 5.0, 5.0, 7.112251, 4700.0, 4754.074521],
                          [0.0, 5.0, 5.0, 15.0, 4754.074521, 4800.0]])
    expertSatis = np.array([[0.0, 5.0, 5.0, 7.1, 4700.0, 4800.0],             
                          [0.0, 5.0, 7.1, 15.0, 4754.4, 4800.0]])
else:
...
# Print results
if exp == 1:
    print("The results of the effectiveness analysis on AT2 - experiment 3 are as follows:")
elif exp == 2:
    print("The results of the effectiveness analysis on AT2 - experiment 4 are as follows:")
else:
    print("The results of the effectiveness analysis on AT2 - experiment 4 for 100 formulas are as follows:")
