...
form5 = json.loads('["ForAll",[["t"],["Implies",[["And",[[">",["t",0]],["<",["t",15930000]]]],["And",[["<", [["-", ["des_x[ToInt(RealVal(0)+(t-0.0)/10000.0)]","cur_x[ToInt(RealVal(0)+(t-0.0)/10000.0)]"]], 0.02]],[">", ["d2obs[ToInt(RealVal(0)+(t-0.0)/10000.0)]",0.05]] ]] ]] ]]')

# AFC example formula : for t >= 11 and t <= 50, abs(err) <= 0.007
...
at51 = json.loads('["ForAll", ["i", ["Implies", [["And", [[">=", ["i", ["ToInt", [0, 10000.0]] ]], ["<", ["i", ["ToInt", [30000000, 10000.0]] ]] ]], ["Implies", [["And", [["!=", ["gear[(i-1)]", 1]], ["==", ["gear[i]", 1]]]], ["ForAll", ["t2", ["Implies", [["And", [["<=", ["timestamps[i]", "t2"]], ["<=", ["t2", ["+", ["timestamps[i]", 2500000]]]] ]], ["==", ["gear[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 1]] ]] ]] ]] ]] ]]')
at52 = json.loads('["ForAll", ["i", ["Implies", [["And", [[">=", ["i", ["ToInt", [0, 10000.0]] ]], ["<", ["i", ["ToInt", [30000000, 10000.0]] ]] ]], ["Implies", [["And", [["!=", ["gear[(i-1)]", 2]], ["==", ["gear[i]", 2]]]], ["ForAll", ["t2", ["Implies", [["And", [["<=", ["timestamps[i]", "t2"]], ["<=", ["t2", ["+", ["timestamps[i]", 2500000]]]] ]], ["==", ["gear[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 2]] ]] ]] ]] ]] ]]')
at53 = json.loads('["ForAll", ["i", ["Implies", [["And", [[">=", ["i", ["ToInt", [0, 10000.0]] ]], ["<", ["i", ["ToInt", [30000000, 10000.0]] ]] ]], ["Implies", [["And", [["!=", ["gear[(i-1)]", 3]], ["==", ["gear[i]", 3]]]], ["ForAll", ["t2", ["Implies", [["And", [["<=", ["timestamps[i]", "t2"]], ["<=", ["t2", ["+", ["timestamps[i]", 2500000]]]] ]], ["==", ["gear[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 3]] ]] ]] ]] ]] ]]')
at54 = json.loads('["ForAll", ["i", ["Implies", [["And", [[">=", ["i", ["ToInt", [0, 10000.0]] ]], ["<", ["i", ["ToInt", [30000000, 10000.0]] ]] ]], ["Implies", [["And", [["!=", ["gear[(i-1)]", 4]], ["==", ["gear[i]", 4]]]], ["ForAll", ["t2", ["Implies", [["And", [["<=", ["timestamps[i]", "t2"]], ["<=", ["t2", ["+", ["timestamps[i]", 2500000]]]] ]], ["==", ["gear[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 4]] ]] ]] ]] ]] ]]')
...
at6a = json.loads('["Implies", [["ForAll", [["t1"], ["Implies", [["And", [["<=", [0,"t1"]], ["<=", ["t1", 30000000]]]], ["<", ["e_speed[ToInt(RealVal(0)+(t1-0.0)/10000.0)]", 3000]]]]]], ["ForAll", [["t2"], ["Implies", [["And", [["<=", [0,"t2"]], ["<=", ["t2", 4000000]]]], ["<", ["v_speed[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 35]]]]]]]]')
...
at6b = json.loads('["Implies", [["ForAll", [["t1"], ["Implies", [["And", [["<=", [0,"t1"]], ["<=", ["t1", 30000000]]]], ["<", ["e_speed[ToInt(RealVal(0)+(t1-0.0)/10000.0)]", 3000]]]]]], ["ForAll", [["t2"], ["Implies", [["And", [["<=", [0,"t2"]], ["<=", ["t2", 8000000]]]], ["<", ["v_speed[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 50]]]]]]]]')
...
at6c = json.loads('["Implies", [["ForAll", [["t1"], ["Implies", [["And", [["<=", [0,"t1"]], ["<=", ["t1", 30000000]]]], ["<", ["e_speed[ToInt(RealVal(0)+(t1-0.0)/10000.0)]", 3000]]]]]], ["ForAll", [["t2"], ["Implies", [["And", [["<=", [0,"t2"]], ["<=", ["t2", 20000000]]]],["<", ["v_speed[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 65]]]]]]]]')

["And", ["AT6B", "AT6C"]]
["And", ["AT6A", ["And", ["AT6B", "AT6C"]]]]
# at6abc = json.loads('["And", ["AT6A", ["And", ["AT6B", "AT6C"]]]]')
# at6a = json.loads('["Implies", [["ForAll", [["t1"], ["Implies", [["And", [["<=", [0,"t1"]], ["<=", ["t1", 30000000]]]], ["<", ["v_speed[ToInt(RealVal(0)+(t1-0.0)/10000.0)]", 3000]]]]]], ["ForAll", [["t2"], ["Implies", [["And", [["<=", [0,"t2"]], ["<=", ["t2", 4000000]]]], ["<", ["v_speed[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 35]]]]]]]]')
# at6b = json.loads('["Implies", [["ForAll", [["t1"], ["Implies", [["And", [["<=", [0,"t1"]], ["<=", ["t1", 30000000]]]], ["<", ["v_speed[ToInt(RealVal(0)+(t1-0.0)/10000.0)]", 3000]]]]]], ["ForAll", [["t2"], ["Implies", [["And", [["<=", [0,"t2"]], ["<=", ["t2", 8000000]]]], ["<", ["v_speed[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 50]]]]]]]]')
# at6c = json.loads('["Implies", [["ForAll", [["t1"], ["Implies", [["And", [["<=", [0,"t1"]], ["<=", ["t1", 30000000]]]], ["<", ["v_speed[ToInt(RealVal(0)+(t1-0.0)/10000.0)]", 3000]]]]]], ["ForAll", [["t2"], ["Implies", [["And", [["<=", [0,"t2"]], ["<=", ["t2", 20000000]]]],["<", ["v_speed[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 65]]]]]]]]')
at6abc = json.loads('["And", [["Implies", [["ForAll", [["t1"], ["Implies", [["And", [["<=", [0,"t1"]], ["<=", ["t1", 30000000]]]], ["<", ["e_speed[ToInt(RealVal(0)+(t1-0.0)/10000.0)]", 3000]]]]]], ["ForAll", [["t2"], ["Implies", [["And", [["<=", [0,"t2"]], ["<=", ["t2", 4000000]]]], ["<", ["v_speed[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 35]]]]]]]], ["And", [["Implies", [["ForAll", [["t3"], ["Implies", [["And", [["<=", [0,"t3"]], ["<=", ["t3", 30000000]]]], ["<", ["e_speed[ToInt(RealVal(0)+(t3-0.0)/10000.0)]", 3000]]]]]], ["ForAll", [["t4"], ["Implies", [["And", [["<=", [0,"t4"]], ["<=", ["t4", 8000000]]]], ["<", ["v_speed[ToInt(RealVal(0)+(t4-0.0)/10000.0)]", 50]]]]]]]], ["Implies", [["ForAll", [["t5"], ["Implies", [["And", [["<=", [0,"t5"]], ["<=", ["t5", 30000000]]]], ["<", ["e_speed[ToInt(RealVal(0)+(t5-0.0)/10000.0)]", 3000]]]]]], ["ForAll", [["t6"], ["Implies", [["And", [["<=", [0,"t6"]], ["<=", ["t6", 20000000]]]],["<", ["v_speed[ToInt(RealVal(0)+(t6-0.0)/10000.0)]", 65]]]]]]]]]]]]')
...
cc2  = json.loads('["ForAll", ["t1", ["Implies", [["And", [["<=", [0, "t1"]], ["<=", ["t1", 70000000]] ]], ["Exists", ["t2", ["And", [["And", [["<=", [["+", ["t1", 0]], "t2"]], ["<=", ["t2", ["+", ["t1", 30000000]] ]] ]], [">", [["-", ["y5[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", "y4[ToInt(RealVal(0)+(t2-0.0)/10000.0)]"]], 15]] ]] ]] ]] ]]')

cc3  = json.loads('["ForAll", ["t1", ["Implies", [["And", [["<=", [0, "t1"]], ["<=", ["t1", 80000000]] ]], ["Or", [["ForAll", ["t3", ["Implies", [["And", [["<=", ["t1", "t3"]], ["<=", ["t3", ["+", ["t1", 20000000]]]] ]], ["<", [["-", ["y2[ToInt(RealVal(0)+(t3-0.0)/10000.0)]", "y1[ToInt(RealVal(0)+(t3-0.0)/10000.0)]"]], 20]] ]]]], ["Exists", ["t2", ["And", [["And", [["<=", ["t2", ["+", ["t1", 20000000]]]], ["<=", ["t1", "t2"]] ]], [">", [["-", ["y5[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", "y4[ToInt(RealVal(0)+(t2-0.0)/10000.0)]"]], 40]] ]]]] ]] ]]]]')

cc4  = json.loads('["ForAll", ["t1", ["Implies", [["And", [["<=", [0, "t1"]], ["<=", ["t1", 65000000]] ]], ["Exists", ["t2", ["And", [["And", [["<=", ["t1", "t2"]], ["<=", ["t2", ["+", ["t1", 30000000]] ]] ]], ["ForAll", ["t3", ["Implies", [["And", [["<=", ["t2", "t3"]], ["<=", ["t3", ["+", ["t2", 5000000]] ]] ]], [">", [["-", ["y5[ToInt(RealVal(0)+(t3-0.0)/10000.0)]", "y4[ToInt(RealVal(0)+(t3-0.0)/10000.0)]" ]], 8 ]] ]] ]] ]] ]] ]] ]]')
...
cc5  = json.loads('["ForAll", ["t4", ["Implies", [["And", [["<=", [0, "t4"]], ["<=", ["t4", 72000000]] ]], ["Exists", ["t3", ["And", [["And", [["<=", ["t4", "t3"]], ["<=", ["t3", ["+", ["t4", 8000000]] ]] ]], ["Implies", [["ForAll", ["t2", ["Implies", [["And", [["<=", ["t3", "t2"]], ["<=", ["t2", ["+", ["t3", 5000000]] ]] ]], [">", [["-", ["y2[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", "y1[ToInt(RealVal(0)+(t2-0.0)/10000.0)]" ]], 9 ]] ]] ]], ["ForAll", ["t2", ["Implies", [["And", [["<=", [["+", ["t2", 5000000]], "t1"]], ["<=", ["t1", ["+", ["t2", 20000000]] ]] ]], [">", [["-", ["y5[ToInt(RealVal(0)+(t1-0.0)/10000.0)]", "y4[ToInt(RealVal(0)+(t1-0.0)/10000.0)]" ]], 9 ]] ]] ]] ]] ]] ]] ]] ]]')
...
ccx  = json.loads('["And", [["And", [["And", [["ForAll", ["t1", ["Implies", [["And", [["<=", [0, "t1"]], ["<=", ["t1", 50000000]]]], [">", [["-", ["y5[ToInt(RealVal(0)+(t1-0.0)/10000.0)]", "y4[ToInt(RealVal(0)+(t1-0.0)/10000.0)]"]], 7.5]]]] ]], ["ForAll", ["t2", ["Implies", [["And", [["<=", [0, "t2"]], ["<=", ["t2", 50000000]]]], [">", [["-", ["y4[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", "y3[ToInt(RealVal(0)+(t2-0.0)/10000.0)]"]], 7.5]]]] ]] ]], ["ForAll", ["t3", ["Implies", [["And", [["<=", [0, "t3"]], ["<=", ["t3", 50000000]]]], [">", [["-", ["y3[ToInt(RealVal(0)+(t3-0.0)/10000.0)]", "y2[ToInt(RealVal(0)+(t3-0.0)/10000.0)]"]], 7.5]]]] ]] ]], ["ForAll", ["t4", ["Implies", [["And", [["<=", [0, "t4"]], ["<=", ["t4", 50000000]]]], [">", [["-", ["y2[ToInt(RealVal(0)+(t4-0.0)/10000.0)]", "y1[ToInt(RealVal(0)+(t4-0.0)/10000.0)]"]], 7.5]]]] ]] ]]')
