...
at51 = json.loads('["ForAll", ["t1", ["Implies", [["And", [["<=", [0,"t1"]], ["<=", ["t1", 30000000]] ] ], ["ForAll", ["i", ["Implies", [["And", [[">=", ["i",0]], ["<", ["i","ToInt(RealVal(0)+((t1)-0.0)/10000.0)"]] ] ], ["Implies", [["And", [["!=", ["gear[(i-1)]",1]], ["==", ["gear[i]",1]]]], ["ForAll", ["t2", ["Implies", [["And",[["<=", ["timestamps[i]","t2"]], ["<=", ["t2",["+", ["timestamps[i]",2500000]]]]]], ["==", ["gear[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 1]]] ]]] ]]]]]]]] ] ]')
# z3solver.add(Not(ForAll([t1],           Implies(And(1<=t1, t1<=(30000000)),                              ForAll([i], Implies(And(i>=1, i<ToInt(RealVal(0)+((t1)-0.0)/10000.0)),                                         Implies(And(gear[(i-1)]!=2, gear[i]==2),                                     ForAll([t2], Implies(And(t1<=t2, t2<=t1+((2500000))),                                                       gear[ToInt(RealVal(0)+(t2-0.0)/10000.0)]==2)))))))))
at52 = json.loads('["ForAll", ["t1", ["Implies", [["And", [["<=", [0,"t1"]], ["<=", ["t1", 30000000]] ] ], ["ForAll", ["i", ["Implies", [["And", [[">=", ["i",0]], ["<", ["i","ToInt(RealVal(0)+((t1)-0.0)/10000.0)"]]] ], ["Implies", [["And",[["!=", ["gear[(i-1)]", 2]], ["==", ["gear[i]", 2]]]], ["ForAll", ["t2", ["Implies", [["And", [["<=", ["timestamps[i]","t2"]], ["<=", ["t2", ["+",["timestamps[i]",2500000]]]]]], ["==", ["gear[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 2]]]]]] ]]]]]]]]]]')
#  z3solver.add(Not(ForAll([t1],       Implies(And(0<=t1,                      t1<=(30000000)),                 ForAll([i],        Implies(And(i>=0, i<ToInt(RealVal(0)+((t1)-0.0)/10000.0)),                           Implies(And(gear[(i-1)]!=3, gear[i]==3),                                         ForAll([t2], Implies(And(t1<=t2, t2<=t1+(2500000)),                                                       gear[ToInt(RealVal(0)+(t2-0.0)/10000.0)]==3)))))))))
at53 = json.loads('["ForAll", ["t1", ["Implies", [["And", [["<=", [0,"t1"]], ["<=", ["t1", 30000000]]]],   ["ForAll", ["i", ["Implies", [["And", [[">=", ["i",0]], ["<", ["i","ToInt(RealVal(0)+((t1)-0.0)/10000.0)"]]]],   ["Implies", [["And",[["!=", ["gear[(i-1)]", 3]], ["==", ["gear[i]",3]]]], ["ForAll", ["t2", ["Implies", [["And",[["<=", ["timestamps[i]","t2"]], ["<=", ["t2",["+", ["timestamps[i]",2500000]]]]]], ["==", ["gear[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 3]]]]]] ]]]]]]]]]]')
...
at54 = json.loads('["ForAll", ["t1", ["Implies", [["And", [["<=", [0,"t1"]], ["<=", ["t1", 30000000]]]],   ["ForAll", ["i", ["Implies", [["And", [[">=", ["i",0]], ["<", ["i","ToInt(RealVal(0)+((t1)-0.0)/10000.0)"]]]], ["Implies", [["And",[["!=", ["gear[(i-1)]", 4]], ["==", ["gear[i]", 4]]]], ["ForAll", ["t2", ["Implies", [["And",[["<=", ["timestamps[i]","t2"]], ["<=", ["t2",["+", ["timestamps[i]",2500000]]]]]], ["==", ["gear[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 4]]]]]] ]]]]]]]]]]')
...
at6a = json.loads('["Implies", [["ForAll", [["t1"], ["Implies", [["And", [["<=", [0,"t1"]], ["<=", ["t1", 30000000]]]], ["<", ["e_speed[ToInt(RealVal(0)+(t1-0.0)/10000.0)]", 3000]]]]]], ["ForAll", [["t2"], ["Implies", [["And", [["<=", [0,"t2"]], ["<=", ["t2", 4000000]]]], ["<", ["v_speed[ToInt(RealVal(0)+(t2-0.0)/10000.0)]", 35]]]]]]]]')
at6b = json.loads('["Implies", [["ForAll", [["t3"], ["Implies", [["And", [["<=", [0,"t3"]], ["<=", ["t3", 30000000]]]], ["<", ["e_speed[ToInt(RealVal(0)+(t3-0.0)/10000.0)]", 3000]]]]]], ["ForAll", [["t4"], ["Implies", [["And", [["<=", [0,"t4"]], ["<=", ["t4", 8000000]]]], ["<", ["v_speed[ToInt(RealVal(0)+(t4-0.0)/10000.0)]", 50]]]]]]]]')
at6c = json.loads('["Implies", [["ForAll", [["t5"], ["Implies", [["And", [["<=", [0,"t5"]], ["<=", ["t5", 30000000]]]], ["<", ["e_speed[ToInt(RealVal(0)+(t5-0.0)/10000.0)]", 3000]]]]]], ["ForAll", [["t6"], ["Implies", [["And", [["<=", [0,"t6"]], ["<=", ["t6", 20000000]]]],["<", ["v_speed[ToInt(RealVal(0)+(t6-0.0)/10000.0)]", 65]]]]]]]]')
