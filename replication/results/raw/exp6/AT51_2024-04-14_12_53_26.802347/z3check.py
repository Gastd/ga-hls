...
def AT51():
	...
	z3solver.add(Not(ForAll([i], Implies(And((i >= (ToInt(RealVal(0)+9344718/10000.0))), (i < (ToInt(RealVal(0)+20163986/10000.0)))), Implies(And((gear[(i-1)] != 1), (gear[i] == 1)), ForAll([t2], Implies(And((timestamps[i] <= t2), (t2 <= (timestamps[i] + 363525))), (gear[ToInt(RealVal(0)+(t2-0.0)/10000.0)] == 1))))))))
