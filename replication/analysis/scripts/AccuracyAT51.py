...
if exp == 1:
    ...
    toolSatis = np.array([[0.0, 0.0, 30.0, 30.0, 0.0, 1.639844]])
    expertSatis = np.array([[0.0, 0.0, 30.0, 30.0, 0.0, 1.65]])
    
elif exp == 2:
    totalRange = np.array([0.0, 15.0, 15.0, 45.0, 0.0, 5.0])
    toolSatis = np.array([[7.242438, 15.0, 15.0, 45.0, 0.0, 5.0],
                          [0.0, 7.242438, 15.0, 45.0, 0.0, 1.633167]])
    expertSatis = np.array([[7.23, 15.0, 15.0, 45.0, 0.0, 5.0],             
                          [0.0, 7.23, 15.0, 45.0, 0.0, 1.65]])
...
# Print results
if exp == 1:
    print("The results of the effectiveness analysis on AT51 - experiment 5 are as follows:")
else:
    print("The results of the effectiveness analysis on AT51 - experiment 6 are as follows:")
