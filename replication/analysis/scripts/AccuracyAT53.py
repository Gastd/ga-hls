...
if exp == 1:
    ...
    toolSatis = np.array([[0.0, 0.0, 30.0, 30.0, 0.0, 2.038172]])
    expertSatis = np.array([[0.0, 0.0, 30.0, 30.0, 0.0, 2.04]])
    
elif exp == 2:
    totalRange = np.array([0.0, 15.0, 15.0, 45.0, 0.0, 5.0])
    toolSatis = np.array([[0.0, 15.0, 15.0, 45.0, 0.0, 2.040122],
                          [0.0, 15.0, 15.0, 18.419529, 2.040122, 5.0]])
    expertSatis = np.array([[0.0, 15.0, 15.0, 18.48, 0.0, 5.0],             
                          [0.0, 15.0, 18.48, 45.0, 0.0, 2.04]])
...
# Print results
if exp == 1:
    print("The results of the effectiveness analysis on AT53 - experiment 9 are as follows:")
else:
    print("The results of the effectiveness analysis on AT53 - experiment 10 are as follows:")
