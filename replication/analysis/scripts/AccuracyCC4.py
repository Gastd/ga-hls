...
exp = 2
if exp == 1:
    totalRange = np.array([0.0, 1.0, 0.0, 1.0, 6.0, 10.0])
    toolSatis = np.array([[0.0, 1.0, 0.0, 1.0, 6.0, 7.775409]])
    expertSatis = np.array([[0.0, 1.0, 0.0, 1.0, 6.0, 7.915200]])
    
elif exp == 2:
    totalRange = np.array([0.0, 2.0, 0.0, 2.0, 6.0, 10.0])
    toolSatis = np.array([[0.0, 1.0, 0.0, 1.0, 6.0, 7.921486],
                          [0.0, 1.0, 1.0, 2.0, 6.0, 10.0],
                          [1.0, 2.0, 0.0, 1.0, 6.0, 10.0]])
    expertSatis = np.array([[0.0, 1.0, 0.0, 1.0, 6.0, 7.91],
                            [0.0, 1.0, 1.0, 2.0, 6.0, 10.0],
                            [1.0, 2.0, 0.0, 2.0, 6.0, 10.0]])
...
# Print results
if exp == 1:
    print("The results of the effectiveness analysis on CC4 - experiment 27 are as follows:")
else:
    print("The results of the effectiveness analysis on CC4 - experiment 28 are as follows:")
