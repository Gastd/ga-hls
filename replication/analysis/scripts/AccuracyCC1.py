...
exp = 2
if exp == 1:
    totalRange = np.array([0.0, 0.0, 100.0, 100.0, 30.0, 50.0])
    toolSatis = np.array([[0.0, 0.0, 100.0, 100.0, 41.167538, 50.0]])
    expertSatis = np.array([[0.0, 0.0, 100.0, 100.0, 41.180040, 50.0]])
    
elif exp == 2:
    totalRange = np.array([0.0, 50.0, 50.0, 100.0, 30.0, 50.0])
    toolSatis = np.array([[0.0, 22.646765, 50.0, 100.0, 41.169757, 50.0],             
                          [22.646765, 50.0, 50.0, 100.0, 30.0, 50.0]])
    expertSatis = np.array([[0.0, 50.0, 50.0, 100.0, 41.2, 50.0],             
                          [22.5, 50.0, 50.0, 100.0, 30.0, 41.2]])
...
# Print results
if exp == 1:
    print("The results of the effectiveness analysis on CC1 - experiment 21 are as follows:")
else:
    print("The results of the effectiveness analysis on CC1 - experiment 22 are as follows:")
