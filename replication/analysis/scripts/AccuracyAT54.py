...
if exp == 1:
    ...
    toolSatis = np.array([[0.0, 0.0, 30.0, 30.0, 0.0, 1.799298]])
    expertSatis = np.array([[0.0, 0.0, 30.0, 30.0, 0.0, 1.80]])
    
elif exp == 2:
    totalRange = np.array([0.0, 15.0, 15.0, 45.0, 0.0, 5.0])
    toolSatis = np.array([[0.0, 15.0, 15.0, 45.0, 0.0, 1.799194],
                          [0.0, 15.0, 15.0, 18.853094, 1.799194, 5.0]])
    expertSatis = np.array([[0.0, 15.0, 15.0, 18.84, 0.0, 5.0],             
                          [0.0, 15.0, 18.84, 45.0, 0.0, 1.80]])
...
# Print results
if exp == 1:
    print("The results of the effectiveness analysis on AT54 - experiment 11 are as follows:")
else:
    print("The results of the effectiveness analysis on AT54 - experiment 12 are as follows:")
